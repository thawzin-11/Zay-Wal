...
const chickenLeg = {
  _id: new ObjectId("617fbe201f27f23a9adfe075"),
  name: "Chicken Leg",
...
const chickenDrumstick = {
  _id: new ObjectId("617fbe201f27f23a9adfe076"),
...
const porkBellySlice = {
  _id: new ObjectId("617fbe201f27f23a9adfe077"),
...
const porkNeck = {
  _id: new ObjectId("617fbe201f27f23a9adfe078"),
  name: "Pork Neck",
  description: "Good for Health",
  category: "Meat & Seafood",
  subcategory: "Pork",
...
const apple = {
  _id: new ObjectId("617fbe201f27f23a9adfe088"),
  name: "Apple",
  description: "Good for Health",
...
const banana = {
  _id: new ObjectId("617fbe201f27f23a9adfe07a"),
  name: "Banana",
  description: "Good for Health",
  category: "Fruits & Vegetables",
  subcategory: "Fruits",
...
const orange = {
  _id: new ObjectId("617fbe201f27f23a9adfe07b"),
  name: "Orange",
  description: "Good for Health",
  category: "Fruits & Vegetables",
  subcategory: "Fruits",
...
const carrot = {
  _id: new ObjectId("617fbe201f27f23a9adfe07c"),
  name: "Carrot",
  description: "Good for Health",
  category: "Fruits & Vegetables",
  subcategory: "Fruits",
...
const goldLabel = {
  _id: new ObjectId("617fbe201f27f23a9adfe07d"),
  name: "Gold Label",
  description: "Good for Health",
  category: "Liquor",
  subcategory: "Whiskey",
...
const hibiki = {
  _id: new ObjectId("617fbe201f27f23a9adfe07e"),
  name: "Hibiki",
  description: "Good for Health",
  category: "Liquor",
  subcategory: "Whiskey",
...
const glenfiddich = {
  _id: new ObjectId("617fbe201f27f23a9adfe07f"),
  name: "Glenfiddich",
  description: "Good for Health",
  category: "Liquor",
  subcategory: "Whiskey",
...
const sunkist = {
  _id: new ObjectId("617fbe201f27f23a9adfe080"),
  name: "Sunkist",
  description: "Good for Health",
...
const dPopCola = {
  _id: new ObjectId("617fbe201f27f23a9adfe081"),
  name: "D-pop Cola",
  description: "Good for Health",
  category: "Beverages & Snacks",
  subcategory: "Soft Drink",
...
const nescafe = {
  _id: new ObjectId("617fbe201f27f23a9adfe082"),
  name: "Nescafe",
  description: "Good for Health",
  category: "Beverages & Snacks",
  subcategory: "Soft Drink",
